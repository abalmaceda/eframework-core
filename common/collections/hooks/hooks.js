 ...
 * @summary EFrameworkCore Collection Hooks
 * @description Extends Mongo.Collection with before/after hooks for insert, update, remove, find, and findOne.
...
/**
 * applyVariantDefaults
 * @summary Helper function para settear valores deffault para Hooks
 * @description Es esta la manera con la cual realmente se agregan los valores default para los variants cuando son setteados
...
applyVariantDefaults = function (variant) {
	return _.defaults(variant, {
		...
		/*TODO: Valor antiguo << updatedAt: new Date, >>*/
		updatedAt: new Date(),
		createdAt: new Date()
	});
};
